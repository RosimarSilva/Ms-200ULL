...
#define BitsIoLdd3_PRPH_BASE_ADDRESS  0x400FF080U
...
#define BitsIoLdd3_MODULE_BASE_ADDRESS PTC_BASE_PTR /*!< Name of macro used as the base address */
#define BitsIoLdd3_PORTCONTROL_BASE_ADDRESS PORTC_BASE_PTR /*!< Name of macro used as the base address */
#define BitsIoLdd3_PORT_MASK 0xE000U   /*!< Mask of the allocated pin from the port */
#define BitsIoLdd3_PORT_VALID_VALUE_MASK 0x07 /*!< Mask of the allocated pins from the port as the first pin would be zero i.e. valid bits to be set in method PutVal */
#define BitsIoLdd3_PIN_ALLOC_0_MASK 0x2000 /*!< Mask of the first allocated pin from the port */
#define BitsIoLdd3_PIN_ALLOC_0_INDEX 13U /*!< The index of the first allocated pin from the port */
