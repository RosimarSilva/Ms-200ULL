...
#define BitsIoLdd1_MODULE_BASE_ADDRESS PTB_BASE_PTR /*!< Name of macro used as the base address */
#define BitsIoLdd1_PORTCONTROL_BASE_ADDRESS PORTB_BASE_PTR /*!< Name of macro used as the base address */
#define BitsIoLdd1_PORT_MASK 0x00FC0000U /*!< Mask of the allocated pin from the port */
...
#define BitsIoLdd1_PIN_ALLOC_0_MASK 0x00040000 /*!< Mask of the first allocated pin from the port */
#define BitsIoLdd1_PIN_ALLOC_0_INDEX 18U /*!< The index of the first allocated pin from the port */
