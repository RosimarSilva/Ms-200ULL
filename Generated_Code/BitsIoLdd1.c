...
static const uint32_t BitsIoLdd1_PIN_MASK_MAP[6U] = {
   0x00040000U, 0x00080000U, 0x00100000U, 0x00200000U, 0x00400000U, 0x00800000U
...
LDD_TDeviceData* BitsIoLdd1_Init(LDD_TUserData *UserDataPtr)
{
  ...
  /* GPIOB_PDDR: PDD|=0x00FC0000 */
  GPIOB_PDDR |= GPIO_PDDR_PDD(0x00FC0000);
  /* Set initialization value */
  /* GPIOB_PDOR: PDO&=~0x00FC0000 */
  GPIOB_PDOR &= (uint32_t)~(uint32_t)(GPIO_PDOR_PDO(0x00FC0000));
